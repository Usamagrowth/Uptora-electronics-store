...
const [password, setPassword] = useState("");
 ...
 const handleLogin = (e) => {
  ...
  return (
    <div className="w-full h-fit p-7  bg-[url('./images/headsetimage.jpg')] bg-cover bg-center">
...
<div className="flex flex-col gap-5">
 ...
 <span className="flex flex-row items-center">
  <div className="border border-white w-[390px] h-10 py-2 px-3 rounded-[40px] text-white">
   ...
   className="outline-none bg-transparent w-[95%] h-[100%] placeholder-white" type="password" placeholder="Password" required />
   </div>
